...
class RecursoController extends Controller {
    ...
    private function resolveRecursoPath(string $archivo): ?string
    {
        $safeName = basename($archivo);
        if ($safeName !== $archivo || str_contains($archivo, '..')) {
            return null;
        }

        $basePath = realpath(storage_path('app/public/recursos'));
        $filePath = storage_path('app/public/recursos/' . $safeName);
    ...
    {
        $rutaArchivo = $this->resolveRecursoPath($archivo);
