import { Menu, Group, Center, Burger, Container, rem, Title, Collapse, Box } from '@mantine/core';
            ...
            <Container size="lg">
                <div className={classes.inner}>
                    ...
                    <Group justify="center">
                        <Box visibleFrom="sm">
                            <Link to="/acceso" className={classes.loginBtn}>
                                Iniciar sesión
                                <IconLogin2 size={16} />
                            </Link>
                        </Box>
                ...
                <Collapse in={opened} className={classes.dropdown}>
                    <div className={classes.dropdownInner}>
                        ...
                        <Link
                            to="/acceso"
                            className={`${classes.loginBtn} ${classes.loginBtnMobile}`}
                            onClick={close}
                        >
                            Iniciar sesión
                            <IconLogin2 size={16} />
