...
export function TablaEscuelaMunic() {
    ...
    const stats = useMemo(() => {
        ...
        const inactivas = escuelas.filter((e) => !e.activo).length;
        return { total: escuelas.length, activas, pendientes, inactivas };
    }, [escuelas]);
    ...
    const escuelasPorSubsistema = useMemo(() => {
        if (!subsistemaActivo || subsistemaActivo === TODOS_KEY) {
        ...
        <Box className={classes.page}>
            <Container size="xl" py="xl">
                <ModuleHero
                    ...
                    title="Escuelas del municipio"
                    subtitle="Consulte los centros educativos, filtre por subsistema y revise las escuelas pendientes de validación."
                    backTo="/mi_perfil"
                    ...
                    {!selectedMunicipio ? (
                        <Box className={classes.emptyState}>
                            ...
                            <Text size="sm" c="dimmed" maw={360} mx="auto" mt={4}>
                                Elija provincia y municipio para ver el listado de escuelas registradas.
                            </Text>
                            <Text size="sm" mt="md">
                                <Text component={Link} to="/gestionar_escuela" c="teal" fw={600} inherit>
                            ...
                            <Tabs value={tab} onChange={setTab} variant="pills" radius="md" mb="md">
                                        ...
                                        <Grid.Col span={{ base: 12, md: 4, lg: 3 }}>
                                            <Paper className={classes.roleSidebar} p="md" withBorder radius="lg">
                                                ...
                                                <Text size="xs" c="dimmed" mb="sm">
                                                    Filtre las escuelas por tipo de centro
                                                </Text>
                                                    ...
                                                    <Stack gap={6}>
                                                        ...
                                                        >
                                                            <Group justify="space-between" wrap="nowrap">
                                                                <Text size="sm" fw={subsistemaActivo === TODOS_KEY ? 600 : 500}>
                                                                    Todos
                                                                </Text>
                                        ...
                                        <Grid.Col span={{ base: 12, md: 8, lg: 9 }}>
                                            <Paper className={classes.tableWrap} p="md" withBorder>
                                                <Group justify="space-between" mb="md">
                                                    <div>
                                                        <Title order={4}>
                                                            {subsistemaActivo === TODOS_KEY
                                                                ? 'Todos los subsistemas'
                                                                : subsistemaActivo}
                                                        </Title>
                                                        <Text size="sm" c="dimmed">
                                                            {escuelasPorSubsistema.length} escuela
                                                            {escuelasPorSubsistema.length !== 1 ? 's' : ''}
                                                        </Text>
                                                    </div>
                                                </Group>
                                                <EscuelasTable
                                ...
                                <Tabs.Panel value="pendientes" pt="md">
                                    <Paper className={classes.tableWrap} p="md" withBorder>
                                        <Group justify="space-between" mb="md">
                                            <div>
                                                <Title order={4}>Pendientes de validación</Title>
                                                <Text size="sm" c="dimmed">
                                                    Escuelas registradas que aún no han sido validadas
                                                </Text>
                                            </div>
                                        </Group>
                                        <EscuelasTable
                        ...
                        <SimpleGrid cols={1} spacing="sm">
                            ...
                            <Box className={classes.detailBlock}>
                                ...
                                <Group gap="xs">
                                    ...
                                    <Badge
                                        variant="light"
                                        color={detalle.validado ? 'green' : 'yellow'}
                                    >
