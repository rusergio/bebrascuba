...
export function TablaProfesProvinc() {
    ...
    const subtitulo = loadingTerritorio
        ...
        : provinciaNombre
          ? `Provincia: ${provinciaNombre}. Seleccione un municipio para ver sus profesores.`
        ...
        <Box className={classes.page}>
            <Container size="xl" py="xl">
                <ModuleHero
                    ...
                    title="Profesores de la provincia"
                    subtitle={subtitulo}
                    backTo="/pag-provinc/tabla-esc-prov"
                    backLabel="Escuelas de la provincia"
                    gradient="teal"
                />
                                ...
                                <Grid gutter="md" align="flex-end">
                                    ...
                                    <Grid.Col span={{ base: 12, sm: 6, md: 4 }}>
                                        <SearchableAsyncCombobox
                                            ...
                                            cacheKey={`municipios-prof-prov-${provinciaCodigo}`}
                                        />
                                    </Grid.Col>
                            ...
                            {!selectedMunicipio ? (
                                <Box className={classes.emptyState}>
                                    ...
                                    <Text size="sm" c="dimmed" maw={360} mx="auto" mt={4}>
                                        ...
                                        . Elija uno para ver sus profesores.
                                    </Text>
                                </Box>
                            ) : loading ? (
                                <Center py={80}>
